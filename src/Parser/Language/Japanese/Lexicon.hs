...
import qualified Parser.Language.Japanese.MaiLexicon as MLEX   --lughtblue
...
setupLexicon langOptions sentence = do
  ...
  let numeration = jumandicParsed ++ mylexiconFiltered ++ commonnouns ++ propernames ++ jumanCN ++ MLEX.verbLexicon ++ MLEX.nriLexicon
